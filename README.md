...
> **Current version: 1.4.0** (see [CHANGELOG.md](CHANGELOG.md)) — distributed as an Android app via Google Play, built in the cloud with [EAS Build](https://docs.expo.dev/build/introduction/).
...
- The user-facing version (`1.4.0`) lives in `app.json`/`package.json` — bump it with `npm run version:patch` (which also updates this README) and merge to master **before** building.
