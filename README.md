...
- The user-facing version (`1.4.3`) lives in `app.json`/`package.json` — bump it with `npm run version:patch` (which also updates this README) and merge to master **before** building.
