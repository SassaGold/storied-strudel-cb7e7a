...
const styles = StyleSheet.create({
  ...
  headerIconBtnPressed: { backgroundColor: "rgba(47,212,196,0.40)" },
  logoWrapper: {
    flex: 1,
    flexDirection: "row",
    alignItems: "center",
  ...
  logoTitle: {
    ...
    textShadowColor: "rgba(47,212,196,0.50)",
  ...
  langModalOptionPressed: { backgroundColor: "rgba(47,212,196,0.22)" },
  langModalOptionText: {
    color: "#8A93A8",
    fontSize: 14,
    fontWeight: "600",
